	...
	return (
		...
		<div className="border-b border-slate-800 py-8 px-4 md:px-8 hover:bg-slate-800/50 transition-colors duration-200 group">
			<div className="mb-6 flex justify-between items-start">
				{/* Badge: Dark Emerald */}
				<span className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-emerald-900/30 text-emerald-400 text-xs font-bold tracking-wide border border-emerald-900/50">
					Ayat {id}
				</span>
			</div>
		...
		<>
			...
			<main className="min-h-screen bg-slate-950 font-sans pb-20">
				<div className="max-w-4xl mx-auto bg-slate-900 shadow-xl rounded-b-3xl min-h-screen border-x border-slate-800">
					...
					<div className="bg-emerald-700 text-white p-8 text-center rounded-b-3xl shadow-lg mb-8 relative overflow-hidden">
					...
					{surah !== "1" && page < 2 && (
						<div className="text-center py-10 px-4 mb-4">
							<p
								className="text-4xl md:text-5xl font-serif text-emerald-500/90 leading-relaxed drop-shadow-sm"
								dir="rtl"
							>
